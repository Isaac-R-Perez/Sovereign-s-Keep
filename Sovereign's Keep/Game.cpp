...
bool Game::initialize() {
	...
	baseEnemies.emplace_back(new Enemy(this, 3, static_cast<int>(SPRITE_SHEETS::crab), EnemyType::crab, Enemy::stats(250.0, 250.0f, 45.0f, 27.0f, 0.1f))); //crab at [2]
	baseEnemies.emplace_back(new Enemy(this, 3, static_cast<int>(SPRITE_SHEETS::minotaur), EnemyType::minotaur, Enemy::stats(175.0, 175.0f, 55.0f, 35.0f, 0.15f))); //minotaur at [3]
