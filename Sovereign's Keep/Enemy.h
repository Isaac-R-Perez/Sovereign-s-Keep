...
const float SLIME_WIDTH = 0.0525f;
const float SLIME_HEIGHT = 0.0525f;
...
const float CRAB_WIDTH = 0.125f;
const float CRAB_HEIGHT = 0.1f;
const float CRAB_TIMER = 0.125f;

const float MINOTAUR_WIDTH = 0.125f;
const float MINOTUAR_HEIGHT = 0.125f;
